      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-netural-700'>
          ...
          <p className='font-medium'>Address:</p>
          {
            isEdit
              ? <p>
                <input className='bg-gray-50' type="text" value={userData.address.line1} onChange={(e) => { prev => ({ ...prev.address, line1: e.target.value }) }} name="" id="" />
                <br />
                <input className='bg-gray-50' type="text" value={userData.address.line2} onChange={(e) => { prev => ({ ...prev.address, line2: e.target.value }) }} name="" id="" />
              </p>
